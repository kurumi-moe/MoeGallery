...
//		super.setDefaultProperties();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (x != -1) {
            ...
            Rect dst = new Rect(Utils.dpToPx(1, getResources()), Utils.dpToPx(2, getResources()),
    ...
    public void setShowPosition(float showPosition) {
        this.showPosition = showPosition;
    }

    public void setHidePosition(float hidePosition) {
        this.hidePosition = hidePosition;
    }

    public float getShowPosition() {
        return showPosition;
    }

    public float getHidePosition() {
        return hidePosition;
    }
